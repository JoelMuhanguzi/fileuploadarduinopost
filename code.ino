...
//const char server[] = "mavconnections.com";
//http://joelmuhanguzi-001-site2.ftempurl.com/   mavconnections.com/
...
void loop() {
  ...
  File dataFile = SD.open("data1.txt");
  ...
  Serial.println("Perform POST request");
  ...
  // Read respnse
  Serial.println("Done doing POST");
